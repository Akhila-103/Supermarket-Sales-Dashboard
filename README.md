...
-Compared sales across different payment methods.
-Tracked monthly sales trends and performance.
-Evaluated product-level profitability.
-Used interactive filters to perform detailed data analysis.
